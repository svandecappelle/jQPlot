Fullscreener = function(chart, chartcanvas){
	this.id = chart;
...
Fullscreener.prototype.bind = function() {
	var that = this;
...
Fullscreener.prototype.unbind = function() {
	var that = this;
...
Fullscreener.prototype.fullscreen = function() {
...
$.jqplot.toggleFullscreen = function(id, chart){
	var screener = new Fullscreener(id, chart);
	screener.bind();
...
Fullscreener.prototype.closefullscreen = function() {
