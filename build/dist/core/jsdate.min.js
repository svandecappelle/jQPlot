...
jsDate.regional["en-US"]=jsDate.regional["en-GB"]=jsDate.regional.en;jsDate.regional.getLocale=function(){var l=jsDate.config.defaultLocale;
...
if(!jsDate.regional.hasOwnProperty(l)){l=jsDate.config.defaultLocale}}return l};var day=24*60*60*1000;
var addZeros=function(num,digits){num=String(num);var i=digits-num.length;var s=String(Math.pow(10,i)).slice(1);
return s.concat(num)};var multipliers={millisecond:1,second:1000,minute:60*1000,hour:60*60*1000,day:day,week:7*day,month:{add:function(d,number){multipliers.year.add(d,Math[number>0?"floor":"ceil"](number/12));
