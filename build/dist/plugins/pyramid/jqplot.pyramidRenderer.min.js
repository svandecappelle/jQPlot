...
this.highlightMouseDown=false;this.highlightColors=[];this.offsetBars=false;if(options.highlightMouseDown&&options.highlightMouseOver==null){options.highlightMouseOver=false
}this.side="right";$.extend(true,this,options);this.renderer.options=options;this._highlightedPoint=null;
this._dataColors=[];this._barPoints=[];this.fillAxis="y";this._primaryAxis="_yaxis";
this._xnudge=0;var opts={lineJoin:"miter",lineCap:"butt",fill:this.fill,fillRect:this.fill,isarc:false,strokeStyle:this.color,fillStyle:this.color,closePath:this.fill,lineWidth:this.lineWidth};
...
s.renderer.shapeRenderer.draw(canvas._ctx,points,opts);canvas=null}function unhighlight(plot){var canvas=plot.plugins.pyramidRenderer.highlightCanvas;
...
}}else{if(neighbor==null){unhighlight(plot)}}}$.jqplot.preInitHooks.push(preInit)
})(jQuery);